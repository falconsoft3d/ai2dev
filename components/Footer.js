...
export default function Footer() {
  ...
  <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
    <div className="mr-12 hidden lg:block">
      <span>We use AI for create code:</span>
    </div>
    <div className="flex justify-center">
      ...
      <a href="https://www.linkedin.com/in/marlon-falc%C3%B3n-3a2aa9a4/" className="mr-6 text-gray-600">
      ...
      <a href="https://github.com/falconsoft3d/" className="text-gray-600">
  ...
  <div className="mx-6 py-10 text-center md:text-left">
    <div className="grid grid-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
      <div className="">
        ...
        <p>
          We love code and we love to share it. We are a group of developers who
        </p>
      </div>
      <div className="">
      ...
      <div className="">
        ...
        <p className="mb-4">
          <a href="https://marlonfalcon.com" className="text-gray-600">marlonfalcon.com</a>
        </p>
      </div>
      <div className="">
        <h6 className="uppercase font-semibold mb-4 flex justify-center md:justify-start">
  ...
  <div className="text-center p-6 bg-gray-200">
    ...
    <a className="text-gray-600 font-semibold" href="https://ai2dev.com/"> Ai2dev</a>
  </div>
</footer>
  );
}
